...
> **历史文档(P6,2026-07-23)**:四期全部完成后编辑器再没有结构性改动,所以这份记录基本还是当前形态。
> 之后的相关变化只有渲染面的增强(代码高亮补语言 P11.7、KaTeX P10.5、Mermaid P11.3)——那些**不碰编辑器**,只在预览与博客页的渲染后阶段跑,见 [`../DESIGN.md`](../DESIGN.md) §10。文档分工见[文档地图](README.md)。
